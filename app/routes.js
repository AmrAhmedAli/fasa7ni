...
router.get('/fight',userController.viewFights);
router.get('/kora',userController.viewKora);
router.get('/malahy',userController.viewMalahy);
router.get('/race',userController.viewRaces);
router.get('/theatre',userController.viewTheatres);
router.get('/trampoline',userController.viewTrampolines);
